...
class SetViewController: UIViewController {
    ...
    func getDataSource(_ fetchRequest: NSFetchRequest<NSFetchRequestResult>?) -> DATASource? {
        ...
        let dataSource = DATASource(tableView: tableView, cellIdentifier: "CardCell", fetchRequest: request!, mainContext: CardMagus.sharedInstance.dataStack!.mainContext, configuration: { cell, item, indexPath in
